...
func main() {
	...
	finalURL, err := url.JoinPath(api.DevNetEndpoint, api.PathGetBlockHeader)
	if err != nil {
		logrus.Warnln("Error: ", err)
		return
	}
	...
	rspCreateUser := response_define.ResponseGetBlockHeader{}
	err = json.Unmarshal(body, &rspCreateUser)
	if err != nil {
		logrus.Warnln("Error: ", err)
		return
	}
	logrus.Infoln("ResponseGetBlockHeader: ", rspCreateUser)
